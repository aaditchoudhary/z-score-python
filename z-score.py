...
import statistics
import random
df=pd.read_csv(r"C:\Users\a2z\Downloads\Data-visualization-master\Data-visualization-master\csv files\z-score-studentMarks.csv")
...
#fig.add_trace(go.Scatter(x=[population_mean,population_mean],y=[0,2],mode="lines",name="Mean"))
#fig.show()
...
df=pd.read_csv(r"C:\Users\a2z\Downloads\Data-visualization-master\Data-visualization-master\csv files\z-score2.csv")
data = df["Math_score"].tolist()
...
df = pd.read_csv(r"C:\Users\a2z\Downloads\Data-visualization-master\Data-visualization-master\csv files\z-score3.csv")
data = df["Math_score"].tolist()
...
df = pd.read_csv(r"C:\Users\a2z\Downloads\Data-visualization-master\Data-visualization-master\csv files\z-score4.csv")
data = df["Math_score"].tolist()
